...
import React__default, { useState, useCallback, forwardRef, useContext, useLayoutEffect, useEffect, useRef, createContext, useMemo, Component, Fragment } from 'react';
...
var TableInfo = function TableInfo(_ref) {
  var startRange = _ref.startRange,
    totalEmployees = _ref.totalEmployees,
    filteredEmployees = _ref.filteredEmployees,
    searchTerm = _ref.searchTerm;
  // Additional information to display when entries are filtered.
  var entriesInfo = searchTerm.trim().length > 0 ? " (filtered from ".concat(totalEmployees, " total entries)") : "";
  // Rendering the component.
  return /*#__PURE__*/React__default.createElement("div", null, "Showing ", filteredEmployees === 0 ? 0 : startRange, " to ", filteredEmployees, " ", "of ", filteredEmployees, " entries", entriesInfo);
};
...
var EntriesPerPageDropdown = function EntriesPerPageDropdown(_ref) {
  ...
  }, /*#__PURE__*/React__default.createElement("span", null, "Show "), /*#__PURE__*/React__default.createElement(StateManagedSelect$1, {
  ...
  }), /*#__PURE__*/React__default.createElement("span", null, " entries"));
};
...
var TablePlugin = function TablePlugin(_ref) {
  var headers = _ref.headers,
    ...
    _ref$showTableInfo = _ref.showTableInfo,
    showTableInfo = _ref$showTableInfo === void 0 ? true : _ref$showTableInfo;
  // State variables to manage the component's behavior
  var _useState = useState(10),
    _useState2 = _slicedToArray$1(_useState, 2),
    entriesPerPage = _useState2[0],
    setEntriesPerPage = _useState2[1];
  ...
  var _useState11 = useState(null),
    ...
    hoveredRow = _useState12[0],
    setHoveredRow = _useState12[1];
  var handleCellHover = function handleCellHover(rowIndex) {
  ...
  var arrayHeader = headers;
  var array = data;
  // Calculating various metrics for display and pagination
  var startRange = (currentPage - 1) * entriesPerPage + 1;
  var endRange = Math.min(currentPage * entriesPerPage, array.length);
  var totalEmployees = array.length;
  var totalPages = Math.ceil(totalEmployees / entriesPerPage);
  var handleHeaderSort = function handleHeaderSort(key) {
    // Toggling sort direction if the same key is clicked again
    if (sortKey === key) {
      setSortDirection(function (prevDirection) {
  ...
  var sortedEmployees = array.slice().sort(function (a, b) {
  ...
  var filteredEmployees = sortedEmployees.filter(function (employee) {
  ...
  var handleEntriesPerPageChange = function handleEntriesPerPageChange(value) {
  ...
  var handleGoToPage = function handleGoToPage(pageNumber) {
  ...
  var currentEmployees = filteredEmployees.slice(startIndex, endIndex);
  // Configurations for pagination buttons
  var PAGE_NEIGHBORS = 1;
  var FIRST_PAGE = 1;
  var pageButtons = [];
  var buttonStyle = {
    padding: '8px 12px',
  ...
  var _loop = function _loop(i) {
    ...
    if (i === FIRST_PAGE || i === totalPages || i >= currentPage - PAGE_NEIGHBORS && i <= currentPage + PAGE_NEIGHBORS) {
      pageButtons.push( /*#__PURE__*/React__default.createElement("button", {
        key: i,
        onClick: function onClick() {
          return handleGoToPage(i);
        },
      ...
      pageButtons.push( /*#__PURE__*/React__default.createElement("span", {
        key: i,
  ...
  var isTableEmpty = array.length === 0 && searchTerm === '';
  var isFilterResultEmpty = filteredEmployees.length === 0 && searchTerm !== '';
  // Rendering the table component with sorting, searching, and pagination controls
  return /*#__PURE__*/React__default.createElement("div", null, showHeader && ( /*#__PURE__*/React__default.createElement("header", {
  ...
  }, "Tableau de Filtrage"))), /*#__PURE__*/React__default.createElement("div", {
  ...
  }, /*#__PURE__*/React__default.createElement("tr", null, arrayHeader.map(function (header, index) {
    return /*#__PURE__*/React__default.createElement("th", {
      key: index,
      onClick: function onClick() {
        return handleHeaderSort(index);
      },
      style: {
        padding: '8px',
        textAlign: 'left',
    ...
    }, header, /*#__PURE__*/React__default.createElement(SortIcon, {
      direction: sortKey === index ? sortDirection : undefined
    })));
  }))), /*#__PURE__*/React__default.createElement("tbody", null, isTableEmpty && !isFilterResultEmpty ? ( /*#__PURE__*/React__default.createElement("tr", null, /*#__PURE__*/React__default.createElement("td", {
    colSpan: arrayHeader.length
  }, "No data available in table"))) : currentEmployees.map(function (employee, rowIndex) {
    return /*#__PURE__*/React__default.createElement("tr", {
      key: rowIndex,
      onMouseEnter: function onMouseEnter() {
        return handleCellHover(rowIndex);
      },
      ...
      style: {
        ...
        margin: '4px 0',
        // Marge entre chaque ligne
        backgroundColor: rowIndex === hoveredRow ? '#d5e5ff' : 'transparent'
      }
    }, arrayHeader.map(function (header, colIndex) {
  ...
  }), isFilterResultEmpty && !isTableEmpty && ( /*#__PURE__*/React__default.createElement("tr", null, /*#__PURE__*/React__default.createElement("td", {
    colSpan: 9
  ...
  }, "Previous"), pageButtons, /*#__PURE__*/React__default.createElement("button", {
